/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6f7989640178fae67b4eb0e4f0334444)
...
declare namespace Cloudflare {
	interface Env {
		...
		ATYOURSERVICE_OAUTH_REDIRECT_URI: "http://localhost:5273/auth/callback" | "https://foo-agent-staging.atyourservice.ai/auth/callback" | "https://foo-agent.atyourservice.ai/auth/callback";
		ATYOURSERVICE_OAUTH_CLIENT_ID: string;
		ATYOURSERVICE_OAUTH_CLIENT_SECRET: string;
		BROWSERBASE_API_KEY: string;
		COMPOSIO_API_KEY: string;
		AppAgent: DurableObjectNamespace<import("./src/server").AppAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_BASE_URL" | "OAUTH_PROVIDER_BASE_URL" | "SETTINGS_ENVIRONMENT" | "ATYOURSERVICE_OAUTH_REDIRECT_URI" | "ATYOURSERVICE_OAUTH_CLIENT_ID" | "ATYOURSERVICE_OAUTH_CLIENT_SECRET" | "BROWSERBASE_API_KEY" | "COMPOSIO_API_KEY">> {}
}
