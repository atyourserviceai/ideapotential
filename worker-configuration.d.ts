/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cb98ac746c2aa34f2cfb629ad73b33de)
// Runtime types generated with workerd@1.20251217.0 2025-08-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AppAgent" | "UserDO";
	}
	interface Env {
		GATEWAY_BASE_URL: "https://atyourserviceai-gateway.motin.eu" | "https://gateway.atyourservice.ai";
		OAUTH_PROVIDER_BASE_URL: "https://atyourserviceai-website.motin.eu" | "https://atyourservice.ai";
		SETTINGS_ENVIRONMENT: "dev" | "staging" | "production";
		ATYOURSERVICE_OAUTH_REDIRECT_URI: "http://localhost:5773/auth/callback" | "https://staging.ideapotential.com/auth/callback" | "https://ideapotential.com/auth/callback";
		ATYOURSERVICE_OAUTH_CLIENT_ID: string;
		ATYOURSERVICE_OAUTH_CLIENT_SECRET: string;
		BROWSERBASE_API_KEY: string;
		COMPOSIO_API_KEY: string;
		SIMULATE_THINKING_TOKENS: string;
		AppAgent: DurableObjectNamespace<import("./src/worker").AppAgent>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_BASE_URL" | "OAUTH_PROVIDER_BASE_URL" | "SETTINGS_ENVIRONMENT" | "ATYOURSERVICE_OAUTH_REDIRECT_URI" | "ATYOURSERVICE_OAUTH_CLIENT_ID" | "ATYOURSERVICE_OAUTH_CLIENT_SECRET" | "BROWSERBASE_API_KEY" | "COMPOSIO_API_KEY" | "SIMULATE_THINKING_TOKENS">> {}
}
