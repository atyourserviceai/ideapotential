...
export function ShareAssetTemplate({
  ...
  console.log("[ShareAssetTemplate] Agent state structure:", {
    ...
    currentIdeaKeys: agentState?.currentIdea ? Object.keys(agentState.currentIdea) : [],
  ...
  if (!hasAssessment) {
    console.log("[ShareAssetTemplate] No assessment data found, using placeholder");
  }
      ...
      >
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <span>•</span>
            <span>Updated: {new Date(assessmentData.updated_at).toLocaleDateString()}</span>
          </div>
        </div>
    ...
    >
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <div style={{ display: "flex" }}>Updated: {new Date(assessmentData.updated_at).toLocaleDateString()}</div>
        </div>
      </div>
      ...
      <div style={{ marginBottom: config.spacing.large, display: "flex", flexDirection: "column" }}>
        <ExportFactorGrid
          checklist={checklistForUi}
          derived={assessmentData.derived}
          variant="full"
      ...
      <div style={{
        ...
        <div style={{
          ...
          ideapotential.com • Assessment completed {new Date().toLocaleDateString()}
        </div>
      </div>
    </div>
  );
