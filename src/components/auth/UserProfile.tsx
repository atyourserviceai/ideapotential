...
export function UserProfile() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {showDropdown && (
        <div className="absolute left-0 right-auto md:left-auto md:right-0 mt-2 w-72 bg-white dark:bg-neutral-800 rounded-lg shadow-lg border border-neutral-200 dark:border-neutral-700 py-2 z-[80]">
